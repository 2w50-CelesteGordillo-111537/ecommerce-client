    ...
    <BasicLayout>
      <Container>
        ...
        <p className="text">
          ...
          sea necesario para la compra de alguno de nuestros productos. FridArt
          no asume la responsabilidad en caso de que entregue dicha clave a
        ...
        <p className="text">
          FridArt a través de su sitio web concede una licencia para que los
        ...
        <p className="text">
          Este FridArt garantiza que la atletico de madrid noticias información
          ...
          FridArt reserva los derechos de cambiar o de modificar estos términos
          sin previo aviso.
        </p><br></br>
